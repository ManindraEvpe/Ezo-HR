export default function CertificationsSection() {
  return (
    <section className="container flex overflow-hidden flex-wrap lg:flex-nowrap">
      ...
      >
        <div className="col-span-3 flex-center border border-t-0 lg:border-t lg:rounded-r-md lg:rounded-br-none">
          <img src="/public/dun-img.png" className="h-12" alt="" />
        </div>
        <div className="border border-t-0 border-r-0 rounded-bl-md lg:rounded-bl-none">
          <img src="/public/iso-img.png" className="h-24" alt="" />
        </div>
        <div className="border border-r-0 border-t-0">
          <img src="/public/iso-2-img.png" className="h-24" alt="" />
        </div>
        <div className="border border-t-0 rounded-br-md">
          <img src="/public/nqcab-img.png" className="h-24" alt="" />
        </div>
      </div>
    </section>
  );
